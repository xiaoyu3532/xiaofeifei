...
{
    protected $exceptTicket = ["orderCallback", "collageCallback", 'collagerefund', 'fictitious', "updateOnlineCoursePrice", "updateOfflineCoursePrice"];
            ...
            if ($message['return_code'] === 'SUCCESS') {
                if ($message['result_code'] === 'SUCCESS') { // 成功
                    ...
                    try {
                        ...
                        //活动关联课程时
                        if ($activityOrder['iscourse_type'] == 1) {
                            //添加课时记录表
                            $table = $activityOrder['course_category'] == 1 ? "" : "zht_course";
