...
use app\common\controller\Del as dels;
...
class Teacher extends BaseController
{
    ...
    //获取机构老师
    public static function getpcTeacher($page = '1', $name = '', $mem_id)
    {
        $where = [
            't.is_del' => 1,
//                'tt.is_del' => 1,
//                'tt.status' => 1,
        ...
        $cname_data = Crud::getRelationData($table, $type = 2, $where, $join, $alias, $order = 't.create_time desc', $field = 't.name,t.brief,t.img,t.create_time,t.id tea_id,tt.name typename', $page);
        if ($cname_data) {
    ...
    //添加机构老师
    public static function addpcTeacher()
    {
        $data = input();
    ...
    //修改机构老师
    public static function setpcTeacher()
    {
        $data = input();
        $where = [
            'id' => $data['tea_id']
    ...
    //获取机构老师详情
    public static function getpcTeacherdetails($tea_id)
    {
        $where = [
            't.type' => 1,
            't.is_del' => 1,
    ...
    //删除老师
    public static function delpcTeacher($tea_id)
    {
        $where = [
            'id' => $tea_id
        ];
    ...
    //获取分类列表
    public static function getpcTeacherTypelist()
    {
        $where1 = [
            'type' => 1,
            'is_del' => 1,
    ...
    //老师分类列表及老师姓名
    public static function getpcTeacherTypesearch()
    {
        $where1 = [
            'type' => 1,
            'is_del' => 1,
