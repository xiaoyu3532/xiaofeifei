...
class Curriculum extends BaseController
{
    ...
    //获取课种列表(课目)
    public static function getczzxCurriculum($page = '1', $name = '', $cg_id = '', $st_id = '')
    {
...
//            'st.is_del'=>1,
    ...
    //获取课种详情
    public static function getczzxCurriculumdetails($course_id)
    {
        $where = [
            'is_del' => 1,
            'type' => 1,
    ...
    //获取课种详情(备用)
    public static function getczzxCurriculumdetailss($course_id)
    {
        $where = [
            'c.is_del' => 1,
            'c.type' => 1,
...
//            'st.is_del'=>1,
    ...
    //添加课种
    public static function addczzxCurriculum()
    {
        $mem_data = self::isuserData();
        $data = input();
        if ($mem_data['type'] == 4) {
        ...
        if ($data['wheel_img']) {
            ...
            $data['wheel_img'] = $wheel_img;
            $data['wheel_imgs'] = $wheel_img;
        }
//        handle_type_deposit('st_id','sts_id',$data)
    ...
    //修改课种
    public static function setczzxCurriculum()
    {
        $data = input();
    ...
    //删除课种
    public static function delczzxCurriculum($course_id)
    {
        $where = [
            'is_del' => 1,
            'type' => 1,
