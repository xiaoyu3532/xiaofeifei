...
{
    //获取能力大分类
    public static function getczzxStudyType($page = '1')
    {
        $where = [
            'is_del' => 1,
            'type' => 1,
    ...
    //获取能力小分类
    public static function getczzxStudyTypeSon($st_id, $page = '1')
    {
        $where = [
            'is_del' => 1,
            'type' => 1,
    ...
    //获取能力大小分类
    public static function getczzxgroupStudyType($page = '1')
    {
        $where = [
            'is_del' => 1,
            'type' => 1,
